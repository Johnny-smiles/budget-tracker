...
A budget tracker with offline capablities to allow users to keep detailed track of there budgets.
  
<h2 id= "installation">Installation</h2>
Hosted on Heroku
    
<h2 id= "technology">Technology Stack</h2>
 Node.Js, Express, JavaScript, MongoDB, HTML, CSS, Heroku
  
<h2 id= "usage">Usage</h2>
For daily budget tracking use.
